...
def build_pdf(filename="INFORME_PRACTICA_09.pdf"):
    ...
    meta_data = [
        ...
        [
            ...
            Paragraph(
                '<b>Repositorio GitHub:</b> <a href="https://github.com/jclozadacastillo/curso-mcp/tree/master/entregas/s09">'
                '<font color="#2B6CB0"><u>github.com/jclozadacastillo/curso-mcp (s09)</u></font></a>',
                body_style,
            ),
        ],
    ]
    ...
    # Banner del enlace de GitHub directo
    repo_box = [
        [
            Paragraph(
                '<b>Enlace directo al Repositorio y Entrega en GitHub:</b><br/>'
                '<a href="https://github.com/jclozadacastillo/curso-mcp/tree/master/entregas/s09">'
                '<font color="#1A365D" size="8.5"><u>https://github.com/jclozadacastillo/curso-mcp/tree/master/entregas/s09</u></font></a> '
                '<i>(Repositorio verificado y público con código, tests e informes)</i>',
                body_style,
            )
        ]
    ]
    t_repo = Table(repo_box, colWidths=[540])
