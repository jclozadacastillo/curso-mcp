...
app = FastAPI(
    title="Sistema de Gestión y Reserva de Espacios",
    description="API REST y MCP para la gestión de reservas de espacios y control de gastos con Spec-Driven Development",
    version="2.0.0",
    lifespan=lifespan,
)
